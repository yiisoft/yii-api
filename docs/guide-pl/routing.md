...
> Info: forma mnoga ID kontrolerów jest tworzona poprzez metodę [[Yiisoft\Inflector\InflectorHelper::pluralize()|pluralize()]]. Uwzględnia ona specjalne zasady tworzenia form mnogich. 
