...
> Info: forma mnoga ID kontrolerów jest tworzona poprzez metodę [[yii\helpers\InflectorHelper::pluralize()|pluralize()]]. Uwzględnia ona specjalne zasady tworzenia form mnogich. 
