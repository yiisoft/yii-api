...
La clase controladora extiende de [[Yiisoft\Rest\ActiveController]]. Especificado por [[Yiisoft\Rest\ActiveController::modelClass|modelClass]]
...
> Puedes configurar esto usando la propiedad [[Yiisoft\Rest\UrlRule::$pluralize]].
...
Puedes utilizar [[Yiisoft\Rest\UrlRule]] para simplificar el enrutamiento de los puntos finales de tu API.
