...
Yii divide este proceso en dos pasos. Primero, el recurso es convertido en un array por [[Yiisoft\Rest\Serializer]].
...
Cuando un proveedor de datos está enviando una respuesta con el API RESTful, [[Yiisoft\Rest\Serializer]] llevará la actual página de los recursos y los serializa como un array de recursos objeto. Adicionalmente, [[Yiisoft\Rest\Serializer]]
