...
Quando um data provider está enviando uma resposta com a API RESTful, o [[Yiisoft\Rest\Serializer]] pegará a página atual de recursos e a serializa como um array de objetos de recurso. Adicionalmente, o [[Yiisoft\Rest\Serializer]] também incluirá as informações de paginação pelo seguinte cabeçalho HTTP:
