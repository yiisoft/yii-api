...
如果你的控制器从[[Yiisoft\Yii\Rest\ActiveController]]类继承，可覆盖 [[Yiisoft\Yii\Rest\Controller::checkAccess()|checkAccess()]] 方法
来执行授权检查，该方法会被[[Yiisoft\Yii\Rest\ActiveController]]内置的操作调用。
