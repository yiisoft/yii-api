...
Класс контроллера наследуется от [[Yiisoft\Rest\ActiveController]]. Мы задали [[Yiisoft\Rest\ActiveController::modelClass|modelClass]]
...
Вы можете использовать [[Yiisoft\Rest\UrlRule]] для упрощения маршрутизации точек входа API.
