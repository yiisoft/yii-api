...
[[Yiisoft\Yii\Rest\Controller]] and [[Yiisoft\Yii\Rest\ActiveController]]. The difference between these two controllers
...
from [[Yiisoft\Yii\Rest\ActiveController]], which will allow you to create powerful RESTful APIs with minimal code.

Both [[Yiisoft\Yii\Rest\Controller]] and [[Yiisoft\Yii\Rest\ActiveController]] provide the following features, some of which
...
[[Yiisoft\Yii\Rest\ActiveController]] in addition provides the following features:
...
you directly return the data. The [[Yiisoft\Yii\Rest\Controller::serializer|serializer]] and the
...
Most RESTful API features provided by [[Yiisoft\Yii\Rest\Controller]] are implemented in terms of [filters](structure-filters.md).
...
These named filters are declared in the [[Yiisoft\Yii\Rest\Controller::behaviors()|behaviors()]] method.
...
to an existing controller that extends from [[Yiisoft\Yii\Rest\ActiveController]]:
...
By default, [[Yiisoft\Yii\Rest\ActiveController]] provides the following actions:

* [[Yiisoft\Yii\Rest\IndexAction|index]]: list resources page by page;
* [[Yiisoft\Yii\Rest\ViewAction|view]]: return the details of a specified resource;
* [[Yiisoft\Yii\Rest\CreateAction|create]]: create a new resource;
* [[Yiisoft\Yii\Rest\UpdateAction|update]]: update an existing resource;
* [[Yiisoft\Yii\Rest\DeleteAction|delete]]: delete the specified resource;
* [[Yiisoft\Yii\Rest\OptionsAction|options]]: return the supported HTTP methods.

All these actions are declared through the [[Yiisoft\Yii\Rest\ActiveController::actions()|actions()]] method.
...
to access and manipulate the requested resource(s). With [[Yiisoft\Yii\Rest\ActiveController]], this can be done
by overriding the [[Yiisoft\Yii\Rest\ActiveController::checkAccess()|checkAccess()]] method like the following,
...
The `checkAccess()` method will be called by the default actions of [[Yiisoft\Yii\Rest\ActiveController]]. If you create
